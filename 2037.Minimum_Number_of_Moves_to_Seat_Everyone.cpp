 ...
 *
 * Return t\he minimum number of moves required to move each student to a seat such that no two students are in the same seat.
 *
...
int main(void) {
	vector<int> seats0 = {3, 1, 5};
	vector<int> students0 = {2, 7, 4};
	cout << minMovesToSeat(seats0, students0) << endl;

	vector<int> seats1 = {4, 1, 5, 9};
	vector<int> students1 = {1, 3, 2, 6};
	cout << minMovesToSeat(seats1, students1) << endl;

	vector<int> seats2 = {2, 2, 6, 6};
